...
public class ReverseMaximumMatchingTest {    
    ...
    public void testSeg() {
        ...
        expResult.add("[以, 新, 的, 姿态, 出, 现在, 世界, 东方]");
        expResult.add("[使, 节约粮食, 进一步, 形成, 风气]");
        expResult.add("[反映, 了, 一, 个人, 的, 精神面貌]");
        expResult.add("[美国加州大学, 的, 科学家, 发现]");
        expResult.add("[我, 好, 不, 挺, 好]");
        expResult.add("[木, 有]");

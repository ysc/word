...
###分词使用方法：
    ...
    12、refine
    我们看一个切分例子：
    切分句子：我国工人阶级和广大劳动群众要更加紧密地团结在党中央周围 
    切分结果：[我国, 工人阶级, 和, 广大, 劳动群众, 要, 更加, 紧密, 地, 团结, 在, 党中央, 周围]
    假如我们想要的切分结果是：
	...
	这样，就能达到我们想要的效果：
	切分句子：我国工人阶级和广大劳动群众要更加紧密地团结在党中央周围 
    切分结果：[我国, 工人, 阶级, 和, 广大, 劳动, 群众, 要, 更加, 紧密, 地, 团结, 在, 党中央, 周围]
	
	我们再看一个切分例子：
	切分句子：在实现“两个一百年”奋斗目标的伟大征程上再创新的业绩
	切分结果：[在, 实现, 两个, 一百年, 奋斗目标, 的, 伟大, 征程, 上, 再创, 新的, 业绩]
	假如我们想要的切分结果是：
	切分结果：[在, 实现, 两个一百年, 奋斗目标, 的, 伟大, 征程, 上, 再创, 新的, 业绩]
	也就是要把“两个 一百年”合并为“两个一百年”，那么我们该怎么办呢？
	我们可以通过在word.refine.path配置项指定的文件classpath:word_refine.txt中增加以下内容：
	两个 一百年=两个一百年
	这样，就能达到我们想要的效果：
	切分句子：在实现“两个一百年”奋斗目标的伟大征程上再创新的业绩
